        ...
        <div className="max-w-2xl mx-auto p-6 bg-gray-800 shadow-lg rounded-lg">
          ...
          {loading ? (
            <div className="space-y-4">
              {[...Array(filteredTasks!.length > 0 ? filteredTasks!.length : null)].map((_, index) => (
                <div key={index} className="p-4 bg-gray-700 rounded-md shadow-md animate-pulse">
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-2">
                      Status:{" "}
                      <span
                        className={`font-medium ${task.status === TaskStatus.Completed
                          ? "text-green-400"
                          : "text-red-400"
                          }`}
                      >
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      onClick={() =>
                        handleComplete(task._id as string, TaskStatus.Completed)
                      }
                    >
                      <svg
                    ...
                    <button
                      ...
                      onClick={() => {
                        const params = new URLSearchParams({ id: task._id as string });
